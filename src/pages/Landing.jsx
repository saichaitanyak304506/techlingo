  ...
  const features = [
    {
      ...
      description:
        'Learn by playing "Guess the Term" - read definitions and pick the right answer.',
    },
    {
      icon: BookOpen,
      title: "Real Examples",
      description:
        "Every term comes with code snippets and real-world usage examples.",
    },
    {
      icon: Trophy,
    ...
    },
    {
      ...
      title: "Peer Learning",
      description:
        "Compare scores on the leaderboard and learn together with colleagues.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
          A Duolingo-style platform that helps freshers learn technical
          vocabulary through interactive games, real code examples, and progress
          tracking.
        </p>
            ...
            {[
              {
                ...
                title: "Pick a Topic",
                description:
                  "Choose from categories like Web Dev, DevOps, Security, and more.",
              },
              {
                step: 2,
                title: "Play the Game",
                description:
                  "Read definitions, code examples, and guess the correct tech term.",
              },
              {
                step: 3,
                title: "Track & Grow",
                description:
                  "Earn XP, maintain streaks, and watch your knowledge expand.",
              },
            ].map((item) => (
              <div key={item.step} className="text-center">
                <div className="inline-flex w-12 h-12 items-center justify-center rounded-full bg-primary text-primary-foreground font-bold mb-4">
                  {item.step}
                </div>
